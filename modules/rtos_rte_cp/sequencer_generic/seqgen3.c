...
int abortTest = FALSE;
int abortS1 = FALSE, abortS2 = FALSE, abortS3 = FALSE, abortS4 = FALSE, abortS5 = FALSE, abortS6 = FALSE,
    abortS7 = FALSE;
...
void main(void) {
    ...
    for (i = 0; i < NUM_CPU_CORES; i++) CPU_SET(i, &allcpuset);
...
void Sequencer(int id) {
    ...
    // current_realtime-start_realtime); syslog(LOG_CRIT, "Sequencer on core %d for cycle %llu @ sec=%6.9lf\n",
